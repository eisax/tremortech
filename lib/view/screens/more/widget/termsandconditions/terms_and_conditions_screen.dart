...
class MyTermsAndConditions extends StatefulWidget {
  const MyTermsAndConditions({super.key});

  @override
  State<MyTermsAndConditions> createState() => _MyTermsAndConditionsState();
}

class _MyTermsAndConditionsState extends State<MyTermsAndConditions> {
  @override
